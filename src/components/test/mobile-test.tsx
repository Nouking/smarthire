    ...
    <MobileContainer maxWidth='lg' className='py-8'>
      <MobileStack spacing='lg'>
        <div className='text-center'>
          <h2 className='mb-4 text-2xl font-bold'>Mobile Component Test</h2>
        ...
        <Card>
          ...
          <CardContent>
            <MobileStack spacing='md' direction='column'>
              ...
              <Button variant='secondary' className='min-h-touch w-full'>
                Secondary Button (44px)
              </Button>
        ...
        <Card>
          ...
          <CardContent>
            <MobileStack spacing='md' direction='column'>
              <Input placeholder='Email address' className='min-h-touch' type='email' />
              <Input placeholder='Password' className='min-h-touch' type='password' />
            </MobileStack>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <ResponsiveGrid cols={{ xs: 1, sm: 2, md: 3 }} gap='md'>
              <div className='bg-secondary rounded p-4 text-center text-sm'>Grid Item 1</div>
              <div className='bg-secondary rounded p-4 text-center text-sm'>Grid Item 2</div>
              <div className='bg-secondary rounded p-4 text-center text-sm'>Grid Item 3</div>
            </ResponsiveGrid>
          </CardContent>
        </Card>
      </MobileStack>
